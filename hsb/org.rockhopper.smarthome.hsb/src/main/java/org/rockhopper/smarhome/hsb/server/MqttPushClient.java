...
public class MqttPushClient {
    ...
    public void reconnectMqttPushClient(){    
        ...
        connect(mqttConfig.getHostUrl(), 
			    ...
			    mqttConfig.getHsbBaseTopic() + "/" + mqttConfig.getStatSubTopic(), 
			    mqttConfig.getTimeout(), 
			    mqttConfig.getKeepalive());
        subscribe(mqttConfig.getHsbBaseTopic() + "/" + mqttConfig.getCommandSubTopic() + "/#", 0);
        subscribe(mqttConfig.getSmsBaseTopic() + "/#", 0);
    }
